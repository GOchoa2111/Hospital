...
CREATE TABLE paciente (
    ...
    genero VARCHAR(10),
    tipo_sangre VARCHAR(10) -- Ejemplo (A+)
...
-- Tabla de Citas Médicas (TB-pibote)
CREATE TABLE cita (
...
-- Tabla de Historial Médico (TB-pibote)
...
VALUES 
('admin', 'C123*', 'Administrador'),
('medico1', 'C456*', 'Medico'),
('recepcion1', 'C789*', 'Recepcionista');
